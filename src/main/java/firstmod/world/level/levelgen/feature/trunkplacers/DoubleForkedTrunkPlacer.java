package firstmod.world.level.levelgen.feature.trunkplacers;
...
public class DoubleForkedTrunkPlacer extends TrunkPlacer {
	public static final Codec<DoubleForkedTrunkPlacer> CODEC = RecordCodecBuilder.create((p_70161_) -> {
		return trunkPlacerParts(p_70161_).apply(p_70161_, DoubleForkedTrunkPlacer::new);
	});
	private static final TrunkPlacerType<DoubleForkedTrunkPlacer> DOUBLE_FORKED_TRUNK_PLACER = TrunkPlacerType.register("double_forked_trunk_placer", CODEC); 

	public DoubleForkedTrunkPlacer(int p_70148_, int p_70149_, int p_70150_) {
		super(p_70148_, p_70149_, p_70150_);
	}

	protected TrunkPlacerType<?> type() {
		return DOUBLE_FORKED_TRUNK_PLACER;
	}
	...
	public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_161828_, BiConsumer<BlockPos, BlockState> p_161829_, Random p_161830_, int p_161831_, BlockPos p_161832_, TreeConfiguration p_161833_) {
		...
		k = p_161832_.getX();
		l = p_161832_.getZ();
		Direction direction2 = Direction.Plane.HORIZONTAL.getRandomDirection(p_161830_);
